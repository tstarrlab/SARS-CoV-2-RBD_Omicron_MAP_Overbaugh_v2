...
```
    ...
    /scratch/local/u6042467/557934/ipykernel_107168/578489049.py:38: MatplotlibDeprecationWarning: The get_cmap function was deprecated in Matplotlib 3.7 and will be removed two minor releases later. Use ``matplotlib.colormaps[name]`` or ``matplotlib.colormaps.get_cmap(obj)`` instead.
...
![png](escape_profiles_Wuhan_Hu_1_files/escape_profiles_Wuhan_Hu_1_18_4.png)
    ...
    expr ranges from -1.24737 to 0.0, here is the scale bar, which is being saved to results/escape_profiles/Wuhan_Hu_1/expr_scalebar_horizontal.pdf
...
![png](escape_profiles_Wuhan_Hu_1_files/escape_profiles_Wuhan_Hu_1_18_7.png)
    ...
    expr ranges from -1.24737 to 0.0, here is the scale bar, which is being saved to results/escape_profiles/Wuhan_Hu_1/expr_scalebar_vertical.pdf
...
```
    ...
    Plotted profile 1 to:
     results/escape_profiles/Wuhan_Hu_1/FIG3_WH1_stackedlogo.pdf
     results/escape_profiles/Wuhan_Hu_1/FIG3_WH1_stackedlogo.png.



    
![png](escape_profiles_Wuhan_Hu_1_files/escape_profiles_Wuhan_Hu_1_26_1.png)
    


    
    Plotted profile 2 to:
     results/escape_profiles/Wuhan_Hu_1/FIG3_WH1_color_by_bind_stackedlogo.pdf
     results/escape_profiles/Wuhan_Hu_1/FIG3_WH1_color_by_bind_stackedlogo.png.
...
![png](escape_profiles_Wuhan_Hu_1_files/escape_profiles_Wuhan_Hu_1_26_3.png)
    ...
    Plotted profile 3 to:
     results/escape_profiles/Wuhan_Hu_1/FIG3_WH1_color_by_expr_stackedlogo.pdf
     results/escape_profiles/Wuhan_Hu_1/FIG3_WH1_color_by_expr_stackedlogo.png.
