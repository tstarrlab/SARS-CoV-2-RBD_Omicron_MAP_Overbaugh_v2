...
```
    ...
    /scratch/local/u6042467/557963/ipykernel_2242377/3576878265.py:38: MatplotlibDeprecationWarning: The get_cmap function was deprecated in Matplotlib 3.7 and will be removed two minor releases later. Use ``matplotlib.colormaps[name]`` or ``matplotlib.colormaps.get_cmap(obj)`` instead.
...
![png](escape_profiles_Omicron_BA2_files/escape_profiles_Omicron_BA2_18_2.png)
    ...
    bind ranges from -1.998 to 0.0, here is the scale bar, which is being saved to results/escape_profiles/Omicron_BA2/bind_scalebar_vertical.pdf
...
![png](escape_profiles_Omicron_BA2_files/escape_profiles_Omicron_BA2_18_7.png)
    ...
    expr ranges from -0.95429 to 0.0, here is the scale bar, which is being saved to results/escape_profiles/Omicron_BA2/expr_scalebar_vertical.pdf
...
```
    ...
    Reading escape-profile configuration from data/escape_profiles_config_Omicron_BA2.yaml
...
```
    ...
    Plotted profile 1 to:
     results/escape_profiles/Omicron_BA2/FIG3_BA2_stackedlogo.pdf
     results/escape_profiles/Omicron_BA2/FIG3_BA2_stackedlogo.png.
...
![png](escape_profiles_Omicron_BA2_files/escape_profiles_Omicron_BA2_26_1.png)
    ...
    Plotted profile 2 to:
     results/escape_profiles/Omicron_BA2/FIG3_BA2_color_by_bind_stackedlogo.pdf
     results/escape_profiles/Omicron_BA2/FIG3_BA2_color_by_bind_stackedlogo.png.
...
![png](escape_profiles_Omicron_BA2_files/escape_profiles_Omicron_BA2_26_3.png)
    ...
    Plotted profile 3 to:
     results/escape_profiles/Omicron_BA2/FIG3_BA2_color_by_expr_stackedlogo.pdf
     results/escape_profiles/Omicron_BA2/FIG3_BA2_color_by_expr_stackedlogo.png.



    
![png](escape_profiles_Omicron_BA2_files/escape_profiles_Omicron_BA2_26_5.png)
    


    
    Plotted profile 4 to:
     results/escape_profiles/Omicron_BA2/FIG4_BA2_stackedlogo.pdf
     results/escape_profiles/Omicron_BA2/FIG4_BA2_stackedlogo.png.
...
![png](escape_profiles_Omicron_BA2_files/escape_profiles_Omicron_BA2_26_7.png)
    ...
    Plotted profile 5 to:
     results/escape_profiles/Omicron_BA2/FIG4_BA2_color_by_bind_stackedlogo.pdf
     results/escape_profiles/Omicron_BA2/FIG4_BA2_color_by_bind_stackedlogo.png.
...
![png](escape_profiles_Omicron_BA2_files/escape_profiles_Omicron_BA2_26_9.png)
    ...
    Plotted profile 6 to:
     results/escape_profiles/Omicron_BA2/FIG4_BA2_color_by_expr_stackedlogo.pdf
     results/escape_profiles/Omicron_BA2/FIG4_BA2_color_by_expr_stackedlogo.png.



    
![png](escape_profiles_Omicron_BA2_files/escape_profiles_Omicron_BA2_26_11.png)
    


    
    Plotted profile 7 to:
     results/escape_profiles/Omicron_BA2/FIGS7_BA2_stackedlogo.pdf
     results/escape_profiles/Omicron_BA2/FIGS7_BA2_stackedlogo.png.
...
![png](escape_profiles_Omicron_BA2_files/escape_profiles_Omicron_BA2_26_13.png)
    ...
    Plotted profile 8 to:
     results/escape_profiles/Omicron_BA2/FIGS7_BA2_color_by_bind_stackedlogo.pdf
     results/escape_profiles/Omicron_BA2/FIGS7_BA2_color_by_bind_stackedlogo.png.
...
![png](escape_profiles_Omicron_BA2_files/escape_profiles_Omicron_BA2_26_15.png)
    ...
    Plotted profile 9 to:
     results/escape_profiles/Omicron_BA2/FIGS7_BA2_color_by_expr_stackedlogo.pdf
     results/escape_profiles/Omicron_BA2/FIGS7_BA2_color_by_expr_stackedlogo.png.



    
![png](escape_profiles_Omicron_BA2_files/escape_profiles_Omicron_BA2_26_17.png)
